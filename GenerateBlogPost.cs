...
namespace AutoContentGenerator
{
    ...
    public static class GenerateBlogPost
    {
        ...
        public static async Task<BlogPost> WriteBlogPost(string existingPosts)
        {
            ...
            string prompt = @$"
Você é redator do meu blog sobre empréstimo consignado para servidores públicos brasileiros chamado Konsi, em konsi.com.br/postagens
Este é um blog sobre empréstimo consignado - abordamos todos os aspectos essenciais e tangenciais relacionados ao crédito consignado, crédito consignado para beneficiários do INSS, etc.
